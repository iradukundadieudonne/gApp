   ...
   <div class="contents">
    <div class="header">
       ...
       <div class="links">
        ...
        <div class="link">
        <a href="home.php" style="text-decoration: 4px underline blue;">Home</a>
    ...
    <div class="body">
            ...
            <center>
            <h6>Welcome on college george fox the butaro </h6> 
        </div>
        </div>
        
            <h1><i>they are student for college george fox:
                college george fox offers a wide range of programs, as you can see in the photos. 
                The students there are very vibrant, and the school offers various courses, including construction, 
                computer technology, and business management With these programs, your child will have the opportunity to start 
                their own career and become a successful entrepreneur.
                 I encourage you to bring your children to this institution for their future success.</i></h1>
        </center>
            </div>
